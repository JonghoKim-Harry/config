...
values."
  (setq-default
   ...
   '(
     ...
     ;;JONGHO: cscope layer (in developement)
     ;;cscope
     ...
     ;;xml (unknown layer)
     spacemacs-purpose   ;; Window-purpose layer
     ;;git
     markdown
     (shell :variables
            shell-default-shell `multi-term   ;; default value of multi-term is same as OS term
   ...
   dotspacemacs-additional-packages '(use-package lsp-mode)
   dotspacemacs-additional-packages '(use-package impatient-mode)
...
values."
  ...
  (setq-default
   ...
   ;;   :size-limit-kb 1000)
   ;; (default nil)
   ;;dotspacemacs-line-numbers nil  ;; NOTE: This is default
...
(custom-set-variables
 ...
 '(package-selected-packages
   '(lsp-java vimrc-mode dactyl-mode xcscope csv-mode htmlize zones impatient-mode ht lsp-mode sql-indent smeargle orgit magit-gitflow magit-popup magit gitignore-mode gitconfig-mode gitattributes-mode git-timemachine git-messenger git-link git-commit with-editor xterm-color shell-pop multi-term eshell-z eshell-prompt-extras esh-help dockerfile-mode docker transient tablist docker-tramp fuzzy company-web web-completion-data company-statistics company-emacs-eclim company-anaconda company auto-yasnippet ac-ispell auto-complete toml-mode racer pos-tip cargo rust-mode web-beautify livid-mode skewer-mode simple-httpd json-mode json-snatcher json-reformat js2-refactor multiple-cursors js2-mode js-doc coffee-mode rvm ruby-tools ruby-test-mode rubocop rspec-mode robe rbenv rake minitest chruby bundler inf-ruby yaml-mode yapfify pyvenv pytest pyenv-mode py-isort pip-requirements live-py-mode hy-mode dash-functional cython-mode anaconda-mode pythonic web-mode tagedit slim-mode scss-mode sass-mode pug-mode less-css-mode haml-mode emmet-mode mmm-mode markdown-toc markdown-mode gh-md nlinum-relative nlinum spinner evil-visualstar evil-visual-mark-mode evil-tutor evil-surround evil-mc evil-matchit evil-lisp-state evil-indent-plus evil-iedit-state iedit evil-exchange evil-ediff evil-args evil-anzu anzu evil undo-tree eclim yasnippet adaptive-wrap ws-butler winum which-key wgrep volatile-highlights vi-tilde-fringe uuidgen use-package toc-org spaceline powerline smex smartparens restart-emacs request rainbow-delimiters popwin persp-mode pcre2el paradox org-plus-contrib org-bullets open-junk-file neotree move-text macrostep lorem-ipsum linum-relative link-hint ivy-hydra indent-guide hydra lv hungry-delete hl-todo highlight-parentheses highlight-numbers parent-mode highlight-indentation helm-make google-translate golden-ratio flx-ido flx fill-column-indicator fancy-battery eyebrowse expand-region exec-path-from-shell evil-unimpaired f evil-search-highlight-persist highlight evil-numbers evil-nerd-commenter evil-escape goto-chg eval-sexp-fu elisp-slime-nav dumb-jump popup dash s diminish define-word counsel-projectile projectile pkg-info epl counsel swiper ivy column-enforce-mode clean-aindent-mode bind-map bind-key auto-highlight-symbol auto-compile packed async aggressive-indent ace-window ace-link avy)))
(custom-set-faces
...
(custom-set-variables
 ...
 '(package-selected-packages
   '(lsp-javacomp lsp-java vimrc-mode dactyl-mode xcscope csv-mode htmlize zones impatient-mode ht lsp-mode sql-indent smeargle orgit magit-gitflow magit-popup magit gitignore-mode gitconfig-mode gitattributes-mode git-timemachine git-messenger git-link git-commit with-editor xterm-color shell-pop multi-term eshell-z eshell-prompt-extras esh-help dockerfile-mode docker transient tablist docker-tramp fuzzy company-web web-completion-data company-statistics company-emacs-eclim company-anaconda company auto-yasnippet ac-ispell auto-complete toml-mode racer pos-tip cargo rust-mode web-beautify livid-mode skewer-mode simple-httpd json-mode json-snatcher json-reformat js2-refactor multiple-cursors js2-mode js-doc coffee-mode rvm ruby-tools ruby-test-mode rubocop rspec-mode robe rbenv rake minitest chruby bundler inf-ruby yaml-mode yapfify pyvenv pytest pyenv-mode py-isort pip-requirements live-py-mode hy-mode dash-functional cython-mode anaconda-mode pythonic web-mode tagedit slim-mode scss-mode sass-mode pug-mode less-css-mode haml-mode emmet-mode mmm-mode markdown-toc markdown-mode gh-md nlinum-relative nlinum spinner evil-visualstar evil-visual-mark-mode evil-tutor evil-surround evil-mc evil-matchit evil-lisp-state evil-indent-plus evil-iedit-state iedit evil-exchange evil-ediff evil-args evil-anzu anzu evil undo-tree eclim yasnippet adaptive-wrap ws-butler winum which-key wgrep volatile-highlights vi-tilde-fringe uuidgen use-package toc-org spaceline powerline smex smartparens restart-emacs request rainbow-delimiters popwin persp-mode pcre2el paradox org-plus-contrib org-bullets open-junk-file neotree move-text macrostep lorem-ipsum linum-relative link-hint ivy-hydra indent-guide hydra lv hungry-delete hl-todo highlight-parentheses highlight-numbers parent-mode highlight-indentation helm-make google-translate golden-ratio flx-ido flx fill-column-indicator fancy-battery eyebrowse expand-region exec-path-from-shell evil-unimpaired f evil-search-highlight-persist highlight evil-numbers evil-nerd-commenter evil-escape goto-chg eval-sexp-fu elisp-slime-nav dumb-jump popup dash s diminish define-word counsel-projectile projectile pkg-info epl counsel swiper ivy column-enforce-mode clean-aindent-mode bind-map bind-key auto-highlight-symbol auto-compile packed async aggressive-indent ace-window ace-link avy)))
(custom-set-faces
 ;; custom-set-faces was added by Custom.
 ;; If you edit it by hand, you could mess it up, so be careful.
 ;; Your init file should contain only one such instance.
